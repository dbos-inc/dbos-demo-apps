...
public class WidgetStoreServiceImpl implements WidgetStoreService {
    ...
    private WidgetStoreService proxy;

    @Autowired
    public void setProxy(@Lazy WidgetStoreService proxy) {
        this.proxy = proxy;
    }
    ...
    public Integer createOrder() {
        var record = dsl.insertInto(ORDERS)
                ...
                .fetchOne();
        return (record != null) ? record.get(ORDERS.ORDER_ID) : null;
    }
    ...
    public void updateOrderProgress(Integer orderId) {
        ...
        Integer progressRemaining = (record != null) ? record.get(ORDERS.PROGRESS_REMAINING) : null;
