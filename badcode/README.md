...
This is axn [DBOS app](https://docs.dbos.dev/) bootstrapped with `dbos-sdk init`.

## Getting Started

First, start the database.
This example works with any Postgres database, but to make things easier, we've provided a nifty script that starts Postgres locally in a Docker container and creates a database:
...
To learn more about DBOS, take a look at [our documentation](https://docs.dbos.dev/) or our [source code](https://github.com/dbos-inc/dbos-ts).
