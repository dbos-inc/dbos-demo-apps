  ...
  const readme = `
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <p class="text-gray-600 mb-6">
            This app contains example code for many DBOS features. You can use it as a template when starting a new DBOS app—start by editing <code class="bg-gray-100 px-1 rounded">src/main.ts</code>.
        </p>
        
        <p class="text-gray-600 mb-6">
            To learn more, check out the
            <a href="https://docs.dbos.dev/typescript/programming-guide" class="text-blue-600 hover:text-blue-800 hover:underline">
