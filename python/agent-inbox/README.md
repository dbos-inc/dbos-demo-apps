...
From a dashboard, see which agentic tasks need approval and approve or deny them.

<img width="2521" height="1254" alt="image" src="https://github.com/user-attachments/assets/a4a01494-e641-461c-97e9-bf4125be324c" />

To see how it works and how you can adopt this pattern to build your own durable agents, check out the agent code in `main.py`.
