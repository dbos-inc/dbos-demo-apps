...
from .api import search_hackernews_step, get_comments_step
from .agent import (
    plan_research_step,
...
def agentic_research_workflow(
    ...
    return {
        ...
        "summary": {
            ...
            "avg_relevance": sum(f.get("relevance_score", 0) for f in all_findings) / len(all_findings) if all_findings else 0
        }
    }
